...
def generate_demo_recommendations():
    return [
        {"id": "rec_001", "title": "Reduce ANALYTICS_WH auto-suspend timeout", "description": "ANALYTICS_WH auto-suspend is set to 600s. Based on your usage patterns, reducing it to 120s could save approximately $240/month.", "category": "warehouse", "potential_savings": 240, "effort": "low", "priority": "high"},
        {"id": "rec_002", "title": "Right-size ANALYTICS_WH from LARGE to MEDIUM", "description": "ANALYTICS_WH average query parallelism is 1.2 - well below LARGE capacity. Downsizing to MEDIUM cuts credit spend by 50% with minimal latency impact.", "category": "warehouse", "potential_savings": 580, "effort": "low", "priority": "high"},
        {"id": "rec_003", "title": "Add clustering keys to top scanned tables", "description": "5 slow queries on PROD_DB.PUBLIC tables are doing full table scans (40GB+). Adding a clustering key on (created_at, customer_id) could reduce scan by ~75% and save ~$180/month.", "category": "query", "potential_savings": 180, "effort": "medium", "priority": "high"},
        {"id": "rec_004", "title": "Enable result caching on REPORTING_WH", "description": "35% of REPORTING_WH queries are identical repeated requests from dashboards. Enabling USE_CACHED_RESULT could eliminate redundant compute worth ~$95/month.", "category": "query", "potential_savings": 95, "effort": "low", "priority": "medium"},
        {"id": "rec_005", "title": "Archive 12 stale tables in STAGING", "description": "12 tables in STAGING and RAW_DATA haven't been accessed in 60+ days and occupy 85GB. Dropping or archiving them could save ~$58/month in storage.", "category": "storage", "potential_savings": 58, "effort": "low", "priority": "medium"},
    ]
